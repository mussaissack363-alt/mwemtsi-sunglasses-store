...
export default function App() {
  ...
  const { scene: glassesScene, progress: modelProgress, failed: modelFailed, retry: retryModel } = useGlassesModel()
  ...
  return (
    <>
      <Loading ready={modelReady} progress={modelProgress} failed={modelFailed} onRetry={retryModel} />
